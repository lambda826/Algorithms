...
public class _1826_Faulty_Sensor {

    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // 1. Find common prefix
    // 2. Find variation
    public int badSensor_1trip(int[] arr1, int[] arr2) {
        int n = arr1.length;
        int i = 0;
        // 1. Find common prefix
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public int badSensor_2trip(int[] sensor1, int[] sensor2) {
        boolean f1 = isSubSequence(sensor1, sensor2);
        boolean f2 = isSubSequence(sensor2, sensor1);
        if (f1 && f2) {
            return -1;
        } else if (f1) {
            return 1;
    ...
    private boolean isSubSequence(int[] arr1, int[] arr2) {
        int i1 = arr1.length - 2;
