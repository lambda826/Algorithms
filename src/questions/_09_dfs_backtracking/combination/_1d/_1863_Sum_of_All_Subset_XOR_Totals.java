...
public class _1863_Sum_of_All_Subset_XOR_Totals {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Top-down: use a sum variable passing down to store the XOR value whenever visiting a num
    ...
    private void helper(int[] nums, int index, int pre, int[] sum) {
        for (int i = index; i < nums.length; ++i) {
            sum[0] += pre ^ nums[i];
            helper(nums, i + 1, pre ^ nums[i], sum);
        }
    }
}
