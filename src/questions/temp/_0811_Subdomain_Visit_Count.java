...
public class _0811_Subdomain_Visit_Count {
    ...
    public List<String> subdomainVisits(String[] cpdomains) {
        ...
        for (String domain : cpdomains) {
            ...
            String fullDomain = domain.substring(space + 1);
            map.put(fullDomain, map.getOrDefault(fullDomain, 0) + count);
            int i = 0;
            while ((i = fullDomain.indexOf('.', i) + 1) > 0) {
                String sub = fullDomain.substring(i);
    ...
    public static void main(String[] args) {
        System.out.println(new _0811_Subdomain_Visit_Count().subdomainVisits(new String[] { "9001 discuss.leetcode.com" }));
    }
}
