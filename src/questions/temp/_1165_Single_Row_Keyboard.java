...
public class _1165_Single_Row_Keyboard {
    ...
    /**
     * 1. Record the position of each character of keyboard
     * 2. Go through each character of the word
     */
    public int calculateTime(String keyboard, String word) {
        ...
        int count = pos[word.charAt(0) - 'a'];
        for (int i = 1; i < word.length(); ++i) {
            count += Math.abs(pos[word.charAt(i) - 'a'] - pos[word.charAt(i - 1) - 'a']);
        }
        return count;
    }
}
