...
public class _0638_Shopping_Offers {
    ...
    public static void main(String[] args) {
        List<Integer> price = new ArrayList<>(Arrays.asList(6, 2, 8, 6, 10, 5));
        List<List<Integer>> special = new ArrayList<>();
        special.add(new ArrayList<>(Arrays.asList(5, 1, 6, 2, 0, 2, 19)));
        special.add(new ArrayList<>(Arrays.asList(3, 3, 5, 3, 5, 2, 2)));
        special.add(new ArrayList<>(Arrays.asList(6, 0, 4, 3, 2, 0, 14)));
        special.add(new ArrayList<>(Arrays.asList(5, 5, 4, 1, 6, 3, 23)));
        special.add(new ArrayList<>(Arrays.asList(3, 0, 5, 2, 1, 5, 35)));
        special.add(new ArrayList<>(Arrays.asList(1, 5, 4, 3, 1, 2, 36)));
        special.add(new ArrayList<>(Arrays.asList(6, 6, 4, 2, 4, 1, 5)));
        special.add(new ArrayList<>(Arrays.asList(3, 3, 2, 6, 1, 0, 33)));
        special.add(new ArrayList<>(Arrays.asList(2, 5, 1, 2, 4, 6, 23)));
        special.add(new ArrayList<>(Arrays.asList(3, 6, 2, 6, 2, 6, 14)));
        special.add(new ArrayList<>(Arrays.asList(6, 6, 0, 3, 3, 4, 17)));
        special.add(new ArrayList<>(Arrays.asList(0, 4, 5, 3, 5, 0, 15)));
        special.add(new ArrayList<>(Arrays.asList(6, 1, 0, 6, 4, 0, 14)));
        special.add(new ArrayList<>(Arrays.asList(6, 4, 4, 3, 3, 5, 8)));
        special.add(new ArrayList<>(Arrays.asList(4, 2, 4, 3, 6, 2, 30)));
        special.add(new ArrayList<>(Arrays.asList(3, 4, 0, 3, 1, 4, 3)));
        special.add(new ArrayList<>(Arrays.asList(4, 2, 6, 3, 3, 4, 12)));
        special.add(new ArrayList<>(Arrays.asList(6, 4, 2, 5, 1, 5, 16)));
        special.add(new ArrayList<>(Arrays.asList(3, 1, 0, 0, 3, 2, 3)));
        List<Integer> needs = new ArrayList<>(Arrays.asList(2, 4, 5, 3, 6, 3));
