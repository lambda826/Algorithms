...
public class _0521_Longest_Uncommon_Subsequence_I {
    ...
    /**
     * 1. If a == b, two strings are equal, return -1
     * 2. If a != b && a.len == b.len, as out of these two strings one string will never be a subsequence of other string
     * 3. If a.len != b.len, return max(a.len, b.len)
     */
