package coding.leetcode._10_tree.traversal.universal_traversal;
...
public class _0690_Employee_Importance {
    ...
    public int getImportance_BFS(List<Employee> employees, int id) {
        // Map<Integer, Employee> map = employees.stream().collect(Collectors.toMap(employee -> employee.id, Function.identity()));
